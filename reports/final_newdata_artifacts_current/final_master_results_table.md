# Final Master Results Table - newdata-final

| Method | Detector | Training | Combined val mAP50-95 | HRSID test mAP50-95 | SSDD test mAP50-95 | Note |
|---|---|---|---:|---:|---:|---|
...
| YOLO11s original-only | YOLO11s | real_only | 0.919 | 0.920 | 0.883 | Newer YOLO-family baseline. |
| YOLO11s Stage B-soft curriculum | YOLO11s | real_only -> combined_yolo | 0.949 | 0.951 | 0.916 | Confirms Stage B-soft curriculum transfers to YOLO11s. |
