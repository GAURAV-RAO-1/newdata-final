...
TRAIN_RESULTS = ROOT / "data/crops_sr_realesrgan/manifests/stage_b_soft_realesrgan_x2_train_results.json"
VAL_RESULTS = ROOT / "data/crops_sr_realesrgan/manifests/stage_b_soft_realesrgan_x2_val_results.json"
TEST_RESULTS = ROOT / "data/crops_sr_realesrgan/manifests/stage_b_soft_realesrgan_x2_test_results.json"

OUT_TRAIN = ROOT / "data/crops_sr_realesrgan/manifests/accepted_realesrgan_stage_b_soft_train_manifest.json"
OUT_VAL = ROOT / "data/crops_sr_realesrgan/manifests/accepted_realesrgan_stage_b_soft_val_manifest.json"
OUT_TEST = ROOT / "data/crops_sr_realesrgan/manifests/accepted_realesrgan_stage_b_soft_test_manifest.json"
