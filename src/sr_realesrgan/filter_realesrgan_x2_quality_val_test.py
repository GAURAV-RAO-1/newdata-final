...
GAN_MANIFEST = ROOT / "data/crops_sr_realesrgan/manifests/sr_realesrgan_x2_inference_manifest.json"
GAN_DIR = ROOT / "data/crops_sr_realesrgan/images/x2"

OUT_VAL_JSON = ROOT / "data/crops_sr_realesrgan/manifests/quality_filter_realesrgan_x2_val_results.json"
OUT_TEST_JSON = ROOT / "data/crops_sr_realesrgan/manifests/quality_filter_realesrgan_x2_test_results.json"
OUT_SUMMARY = ROOT / "reports/sr_realesrgan/x2/quality_filter_val_test_summary.json"
