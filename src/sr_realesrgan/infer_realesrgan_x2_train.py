...
OUT_DIR = ROOT / "data/crops_sr_realesrgan/images/x2"
OUT_MANIFEST = ROOT / "data/crops_sr_realesrgan/manifests/sr_realesrgan_x2_train_inference_manifest.json"
...
def main():
    ...
    records = [p for p in data["pairs"] if p["split"] == "train"]
    ...
    print("\nFinished.")
    print(f"Total Real-ESRGAN train outputs saved: {len(out_records)}")
