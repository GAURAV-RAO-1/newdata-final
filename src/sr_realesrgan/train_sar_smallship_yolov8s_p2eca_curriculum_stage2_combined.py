...
INIT_WEIGHTS = ROOT / "runs/sar_smallship_yolov8s_p2eca_curriculum_stage1_realonly/exp/weights/best.pt"
DATA_YAML = ROOT / "data/detector_yolo_exports/newdata_full_realesrgan_x2_stagebsoft_v1_dataset/combined_yolo/dataset.yaml"
PROJECT_DIR = ROOT / "runs/sar_smallship_yolov8s_p2eca_curriculum_stage2_combined"
