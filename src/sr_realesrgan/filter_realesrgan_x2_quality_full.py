...
GAN_MANIFEST = ROOT / "data/crops_sr_realesrgan_full/manifests/sr_realesrgan_x2_full_inference_manifest.json"
GAN_DIR = ROOT / "data/crops_sr_realesrgan_full/images/x2"

OUT_TRAIN_JSON = ROOT / "data/crops_sr_realesrgan_full/manifests/quality_filter_realesrgan_x2_full_train_results.json"
OUT_VAL_JSON = ROOT / "data/crops_sr_realesrgan_full/manifests/quality_filter_realesrgan_x2_full_val_results.json"
OUT_TEST_JSON = ROOT / "data/crops_sr_realesrgan_full/manifests/quality_filter_realesrgan_x2_full_test_results.json"
OUT_SUMMARY = ROOT / "reports/sr_realesrgan_full/x2/quality_filter_full_summary.json"
...
def main():
    ...
    summary = {
        ...
        "val_accepted": sum(r["accepted"] for r in val_results),
        "test_total": len(test_results),
        "test_accepted": sum(r["accepted"] for r in test_results),
    }
    ...
    print(f"Saved val results to: {OUT_VAL_JSON}")
    print(f"Saved test results to: {OUT_TEST_JSON}")
