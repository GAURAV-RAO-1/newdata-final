...
OUT_MANIFEST = ROOT / "data/crops_sr_realesrgan/manifests/sr_realesrgan_x2_inference_manifest.json"
...
def main():
    ...
    with torch.no_grad():
        for p in records:
            ...
            count += 1
            if count % 200 == 0:
                print(f"Saved {count} Real-ESRGAN SR images...")

    OUT_MANIFEST.parent.mkdir(parents=True, exist_ok=True)
    with open(OUT_MANIFEST, "w", encoding="utf-8") as f:
        json.dump({
            "model": "realesrgan_x2_best",
